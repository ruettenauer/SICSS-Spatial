...
In this case `hv_1.sem$lambda` gives us the spatial parameter. In a spatial error model, we can interpret the coefficients directly, as in a conventional linear model. 
