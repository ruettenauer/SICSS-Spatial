...
3. Do results of our spatial models change if we use 10 nearest neighbours for the weights instead of Queens neighbours?

4. Can you think of a way of testing if higher order neighbours add additional information to the SLX regression model? 
...
5. Add the amount of particulate matter (PM10, e.g. 2017) from [Defra](https://uk-air.defra.gov.uk/data/pcm-data) and check if pollution influences the house values 
...
6. Add some more demographic variables from the Census 2011.
