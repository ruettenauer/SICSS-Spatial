...
* Spatial data workhorses: [sf](https://cran.r-project.org/web/packages/sf/index.html) and [stars](https://cran.r-project.org/web/packages/stars/index.html)

* Visualization: [mapview](https://cran.r-project.org/web/packages/mapview/index.html) and [tmap](https://cran.r-project.org/web/packages/tmap/index.html)

* Spatial weights and other relations: [sdep](https://cran.r-project.org/web/packages/stars/index.html)

* Spatial interpolation and kriging: [gstat](https://cran.r-project.org/web/packages/gstat/index.html)

* Spatial regression models: [spatialreg](https://cran.r-project.org/web/packages/spatialreg/index.html)

### Further materials

Readings

* Great up-to-date introduction to spatial R: @Lovelace.2019, [freely available online](https://geocompr.robinlovelace.net/)
